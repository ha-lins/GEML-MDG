...
class Trainer(TrainerBase):
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for step, batch_group in enumerate(train_generator_tqdm):
            # if step < self.gradient_steps:
            # print('[info]batch_group is:{}'.format(batch_group))
    ...
    def _validation_loss(self) -> Tuple[float, int]:
        ...
        batches_this_epoch = 0
        val_loss = 0
        for step, batch_group in enumerate(val_generator_tqdm):
            # if step < self.gradient_steps:
