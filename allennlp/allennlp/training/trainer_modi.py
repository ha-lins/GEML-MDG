...
class Trainer(TrainerBase):
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        # print('==========self.train_data is:{}'.format(self.train_data))
        ...
        # progress is shown
        # print('num_batches is :{}'.format(num_training_batches))
        if self._master:
        ...
        # print('[info] batch_group_generator is:{}'.format(batch_group_generator))

        for i, batch_group in enumerate(batch_group_generator_tqdm): # len is 4
            # print('[info] batch_group is:{}, i is:{}'.format(batch_group[0].keys(), i))
            ...
            for j, batch in enumerate(batch_group):  # len is 0
                # print('[info]batch is:{}, j is:{}'.format(batch.keys(), j))
