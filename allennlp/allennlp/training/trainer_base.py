...
class TrainerBase(Registrable):
    ...
    def __init__(self,
                 ...
                 cuda_device: Union[int, List] = [1, 2]) -> None:
        ...
        print('[info] cuda_device in trainer_base is:{}'.format(cuda_device))
    ...
    def from_params(cls,   # type: ignore
        ...
        if typ3 == "default":
            ...
            klass = TrainerBase.by_name(typ3)  #allennlp.training.metatrainer.MetaTrainer
            print('[info]klass (in trainer_base.py) is:{}'.format(klass))
            ...
            print('[info] trainer (in trainer_base.py) is :{}'.format(params.params.get('trainer')))
