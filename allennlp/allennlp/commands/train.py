...
def train_model(params: Params,
    ...
    cuda_device = params.params.get('trainer').get('cuda_device', [1,2])
    # print('[info] params (in train.py) is :{}'.format(params))
    # print('[info] params.params (in train.py) is :{}'.format(params.params))
    # print('[info] trainer (in train.py) is :{}'.format(params.params.get('trainer')))
